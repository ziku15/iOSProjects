...
//    }
    ...
    tableViewPressRelease = [[UITableView alloc] initWithFrame:CGRectMake(0, 5, self.view.frame.size.width, [[UIScreen mainScreen] bounds].size.height - 70)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _pressDetailsView.isHRArtical = NO;
