...
- (void)textViewDidChange:(UITextView *)textView{
    ...
    if (currentLimit<4) {
        ...
        calculateCharacterRange.alpha = 1.0f;
        [calculateCharacterRange.layer removeAllAnimations];
    }
