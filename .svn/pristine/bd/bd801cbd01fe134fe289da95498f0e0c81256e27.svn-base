...
#define XIBEMAILRegex @"[-0-9a-zA-Z.+_]+@[-0-9a-zA-Z.+_]+\\.[a-zA-Z]{2,4}"
...
- (void)setupLabel {
    ...
    _attributesText = @{NSForegroundColorAttributeName: [UIColor sidraFlatDarkGrayColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.5]};
    _attributesHandle = @{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.5]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:52.0/255.0 green:120.0/255.0 blue:194.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.5]};
    _attributesLink = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:129.0/255.0 green:171.0/255.0 blue:193.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.5]};
    _attributesEmail = @{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.5]};
...
- (void)determineHotWords {
    ...
    _cleanText = [NSString stringWithFormat:@"%@",_cleanText];
    
    NSMutableString *tmpText = [[NSMutableString alloc] initWithString:[NSString stringWithFormat:@"%@",_cleanText]];
...
- (void)determineEmails {
    NSMutableString *tmpText = [[NSMutableString alloc] initWithString:[NSString stringWithFormat:@"%@",_cleanText]];
    
    NSError *regexError = nil;
    NSRegularExpression *regex = [NSRegularExpression regularExpressionWithPattern:XIBEMAILRegex options:0 error:&regexError];
    ...
    [regex enumerateMatchesInString:tmpText options:0 range:NSMakeRange(0, tmpText.length) usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
        ...
        if (protocolRange.location != NSNotFound) {
            [_rangesOfHotWords addObject:@{@"hotWord": @(STTweetEmail), @"protocol": protocol, @"range": [NSValue valueWithRange:result.range]}];
        }
    }];
}
...
- (void)updateText
{
    ...
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:
                                                   [NSString stringWithFormat:@"%@",_cleanText]];
    ...
    frame.origin.y = 0.0f;
    _textView = [[UITextView alloc] initWithFrame:frame textContainer:_textContainer];
