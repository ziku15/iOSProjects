...
#pragma mark - 
#pragma mark - Sidra 
+ (UIColor *)sidraFlatTurquoiseColor {
    return [UIColor colorWithRed:41.0f/255.0f green:172.0f/255.0f blue:203.0f/255.0f alpha:1.0];
}
+ (UIColor *)sidraFlatGrayColor{
    return [UIColor colorWithRed:154.0f/255.0f green:156.0f/255.0f blue:160.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatDarkGrayColor{
    return [UIColor colorWithRed:86.0f/255.0f green:93.0f/255.0f blue:103.0f/255.0f alpha:1.0];
}
+ (UIColor *)sidraFlatBlueColor{
    return [UIColor colorWithRed:35.0f/255.0f green:103.0f/255.0f blue:178.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatGreenColor{
    return [UIColor colorWithRed:12.0f/255.0f green:137.0f/255.0f blue:67.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatRedColor{
    return [UIColor colorWithRed:200.0f/255.0f green:40.0f/255.0f blue:40.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatSkyBlueColor{
    return [UIColor colorWithRed:234.0f/255.0f green:245.0f/255.0f blue:250.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatOliveGreenColor{
    return [UIColor colorWithRed:132.0f/255.0f green:179.0f/255.0f blue:81.0f/255.0f alpha:1.0];
}

+ (UIColor *)sidraFlatLightGrayColor{
    return [UIColor colorWithRed:227.0f/255.0f green:229.0f/255.0f blue:233.0f/255.0f alpha:1.0];
}
