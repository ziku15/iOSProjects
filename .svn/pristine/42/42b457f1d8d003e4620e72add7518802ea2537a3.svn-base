...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [headLineText setFont:[UIFont systemFontOfSize:15]];
        ...
        [releaseDate setTextColor:[UIColor blackColor ]];
        [releaseDate setBackgroundColor:[UIColor clearColor]];
        [releaseDate setFont:[UIFont systemFontOfSize:11]];
        ...
        [source setFont:[UIFont systemFontOfSize:12]];
